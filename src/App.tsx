...
const projects: Project[] = [
  {
    ...
    image360: lucero360,
    description:
      "A timeless, light-filled kitchen with a central island and expansive storage under vaulted ceilings.",
  },
  {
    id: "mcknight",
    number: "02",
    ...
    description:
      "Elegant, functional design with layered cabinetry, open shelving, and statement lighting.",
  },
  {
    id: "brunson",
    number: "03",
