...
const Portfolio: React.FC<PortfolioProps> = ({ projects }) => {
  ...
  const getParallaxStyle = (speed: number, isBackground: boolean = false) => {
    return {
      transform: isBackground
        ? `translateY(${scrollY * speed}px) scale(1.03)`
  ...
  // Add this effect to handle URL hash navigation when the component mounts
  useEffect(() => {
    ...
    const handleHashNavigation = () => {
      ...
      if (hash) {
        ...
        setTimeout(() => {
          if (targetId === "/#contact" && contactSectionRef.current) {
            // Scroll to contact section
            smoothScrollTo(contactSectionRef.current);
          } else if (targetId.startsWith("project-hero-")) {
            // Handle project navigation
            const projectId = targetId.replace("project-hero-", "");
            if (projectRefs.current[projectId]) {
              smoothScrollTo(projectRefs.current[projectId]!);
            }
          }
        }, 100);
      }
    ...
    // Also listen for hash changes while the component is mounted
    ...
    <div className="minimal-container">
      <header
        ...
        style={{
          ...
          visibility:
            window.scrollY < window.innerHeight ? "hidden" : "visible",
        }}
      >
        <div
      ...
      <div
        className="home-logo-container-wrapper"
      ...
      <section className="home-section" ref={infoSectionRef}>
        <div className="home-text">
          <p className="section-main-text" style={getParallaxStyle(-0.1)}>
            We craft virtual experiences that align with your vision - turning
            your imagination into immersive realities.
          </p>
      ...
      <section className="contact-section" ref={contactSectionRef}>
        <div className="contact-content">
          ...
          <p className="section-paragraph">
            Ready to visualize your remodeling project? Contact us to discuss
            how we can help bring your vision to life.
          </p>
          <div className="contact-details">
            <div className="contact-item">
              <EmailIcon sx={{ color: "var(--text-dark)" }} />
              <a href="mailto:info@renovadesign.com" className="contact-value">
      ...
      >
        <button className="hamburger-button" onClick={toggleMenu}>
          <span
            ...
            style={{
              backgroundColor: isInProject() || menuOpen ? "white" : "black",
            }}
          ></span>
          <span
            className="hamburger-line"
